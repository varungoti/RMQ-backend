/**
 * Direct test script to verify that our implementation of createHybridResponse
 * correctly handles the 'correct' property in the response.
 */

import { createHybridResponse } from './common/utils/response-helper';

// Example data that mimics what would come from the assessmentService.submitAnswer method
...
// Example data with isCorrect = false
